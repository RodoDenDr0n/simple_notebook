...
class Menu:
    ...
    def menu(notebook):
        ...
        elif user_command == "show_notes":
            print(colored("\nYour notes:", "cyan", attrs=["bold"]))
            for i in range(len(notebook.notes)):
                print(colored(f" [{i+1}] ", "green") + colored("memo: ", "red") + f"{notebook.notes[i].memo}" +
                      colored("\n     tags: ", "red") + f"{notebook.notes[i].tags}" +
                      colored("\n     creation date: ", "red") + f"{notebook.notes[i].creation_date}")
            return None
    ...
    def get_note_id(notebook):
        ...
        for i in range(len(notes)):
            print(colored(f" [{i+1}] ", "green") + colored("memo: ", "red") + f"{notes[i].memo}" +
                  ...
                  colored("\n     creation date: ", "red") + f"{notes[i].creation_date}")
